...
describe('AI Good News digest generation', () => {
  it('selects recent published stories and avoids duplicate syndicated items', () => {
    const digest = generateDailyDigest([
      ...
      story({
        id: 'climate',
        title: 'AI model improves regional weather forecasts',
        summary: 'A weather forecasting team used AI to improve forecast accuracy and support climate resilience planning.',
        category: 'Climate',
      ...
      story({
        id: 'climate-copy',
        title: 'Regional weather forecasts improve with AI model',
        summary: 'A weather forecasting team used AI to improve forecast accuracy and support climate resilience planning.',
        category: 'Climate',
        canonical_url: 'https://mirror.example/weather',
        source_url: 'https://mirror.example/weather',
      }),
