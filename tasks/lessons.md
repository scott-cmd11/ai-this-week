...
- Positive AI summaries should use the existing `OPENAI_API_KEY` path once stories pass the deterministic good-news gate; the fallback summarizer is only for missing-key or failed-model cases.
